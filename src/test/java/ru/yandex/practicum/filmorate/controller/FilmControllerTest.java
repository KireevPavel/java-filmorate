...
public class FilmControllerTest {
    ...
    protected void init() {
        testFilm = Film.builder()
                .name("“естовый фильм")
                .description("“естовое описание тестового фильма")
    ...
    void createFilm_IncorrectDescription_badRequestTest() throws Exception {
        testFilm.setDescription("–азмер описани€ значительно превышает двести символов, а может и не превышает " +
                "(надо посчитать). Ќет, к сожалению размер описани€ фильма сейчас не превышает двести символов," +
